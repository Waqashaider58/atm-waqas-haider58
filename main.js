...
while (!close) {
    if (myPin.pinCode == 1234) {
        ...
        if (userChoice.operator == "check balance") {
            {
            ...
            if (transaction2.anotherTransaction == "No") {
                close = true, console.log("Thank you for using this ATM");
            }
        }
            ...
            if (withdrawAmount.enteredAmount > accountBalance) {
                ...
                if (transaction3.anotherTransaction3 == "No") {
                    close = true, console.log("Thank you for using this ATM");
                }
            }
            else if (withdrawAmount.enteredAmount == 0) {
                ...
                if (transaction4.anotherTransaction4 == "No") {
                    close = true, console.log("Thank you for using this ATM");
                }
            }
        }
        else if (userChoice.operator == "exit") {
            close = true, console.log("Thank you! see you again");
        }
        ;
    }
    else if (myPin.pinCode !== 1234) {
        close = true, console.log("Please Enter correct pin Code");
    }
}
